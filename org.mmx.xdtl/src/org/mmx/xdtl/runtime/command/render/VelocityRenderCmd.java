...
public class VelocityRenderCmd implements RuntimeCommand {
    private static final Logger logger = XdtlLogger.getLogger("xdtl.cmd.render.vtl");
    ...
    public VelocityRenderCmd(String template, Mappings source, String targetVarName,
