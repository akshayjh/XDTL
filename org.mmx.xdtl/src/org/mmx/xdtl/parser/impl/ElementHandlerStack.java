...
class ElementHandlerStack {
    static class Item {
        ...
        public Item(ElementHandler elementHandler, SourceLocator sourceLocator, String id) {
            super();
    ...
    public void push(ElementHandler elementHandler, SourceLocator sourceLocator, String id) {
        m_list.add(new Item(elementHandler, sourceLocator, id));
    }
